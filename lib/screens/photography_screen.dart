...
class PhotographyScreen extends StatefulWidget {
  ...
  const PhotographyScreen({
    super.key,
    required this.photographyType, required String serviceType,
  });
...
class _PhotographyScreenState extends State<PhotographyScreen> {
  ...
  List<PhotographyItem> get filteredPhotographies {
    return photographies.where((photography) => photography.type == selectedCity).toList();
  }
        ...
        children: [
          ...
          Expanded(
            child: SingleChildScrollView(
              ...
              child: Column(
                children: filteredPhotographies.map((photography) => VenueCard(photography: photography,)).toList(),
              ),
            ),
          ),
            ...
            children: [
              ...
              ClipRRect(
                ...
                child: Container(
                  ...
                  child: photography.imageUrl.startsWith('http')
                      ? Image.network(
